    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('view')}}">| See Product Listing</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('create')}}">| Add a Product</a>
                </li>
...
{{--                        <li><a class="dropdown-item" href="{{route('create')}}">Add a Product</a></li>--}}
{{--                        <li><a class="dropdown-item" href="{{route('edit')}}">Edit a Product</a></li>--}}
